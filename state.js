...
const THEMES={
  pink:{name:'莫蘭迪粉',swatches:['#C59390','#C8A5A3','#D0B0B1'],
    vars:{'--p':'#C8A5A3','--p2':'#D0B0B1','--p3':'#C59390','--latte':'#C59390','--latte2':'#D0B0B1',
          '--surface':'#F9F3F2','--text':'#3A2828','--text2':'#907878','--border':'#EDE0DC',
          '--shadow':'rgba(180,130,130,.06)','--hdr-grad':'linear-gradient(135deg,#C59390 0%,#C8A5A3 50%,#D0B0B1 100%)'}},
  green:{name:'莫蘭迪綠',swatches:['#8DAD93','#9DB8A3','#AEC5B4'],
    vars:{'--p':'#9DB8A3','--p2':'#AEC5B4','--p3':'#8DAD93','--latte':'#8DAD93','--latte2':'#AEC5B4',
          '--surface':'#F3F7F4','--text':'#28362E','--text2':'#6A8872','--border':'#DCE8DF',
          '--shadow':'rgba(100,140,110,.06)','--hdr-grad':'linear-gradient(135deg,#8DAD93 0%,#9DB8A3 50%,#AEC5B4 100%)'}},
  blue:{name:'莫蘭迪藍',swatches:['#8B9FBA','#9BAFC2','#ACCBD8'],
    vars:{'--p':'#9BAFC2','--p2':'#ACCBD8','--p3':'#8B9FBA','--latte':'#8B9FBA','--latte2':'#ACCBD8',
          '--surface':'#F3F5F9','--text':'#28303A','--text2':'#6878A0','--border':'#DCE0EA',
          '--shadow':'rgba(100,120,160,.06)','--hdr-grad':'linear-gradient(135deg,#8B9FBA 0%,#9BAFC2 50%,#ACCBD8 100%)'}},
  warm:{name:'莫蘭迪橙',swatches:['#B89360','#C9A87C','#D8BC98'],
    vars:{'--p':'#C9A87C','--p2':'#D8BC98','--p3':'#B89360','--latte':'#B89360','--latte2':'#D8BC98',
          '--surface':'#FAF6F0','--text':'#3A2E20','--text2':'#9A8060','--border':'#EDE5D8',
          '--shadow':'rgba(160,130,80,.06)','--hdr-grad':'linear-gradient(135deg,#B89360 0%,#C9A87C 50%,#D8BC98 100%)'}},
};
const FONTS={
